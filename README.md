...
- A `.cub`-style map file (floor colour, ceiling colour, then the grid
...
| `map.c` / `map.h` | load a `.cub`-style map file — no SDL2 anywhere |
...
- `fixtures/map1.cub` parses to the right dimensions, and the marked
